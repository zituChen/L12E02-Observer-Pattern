...
public class Rider implements Observer<ExtraClass>{
    ...
    @Override
    public void update(ExtraClass extraClass) {
        notifyAvailabilityChanged(extraClass.getPev(), extraClass.getAvailability());
    }
}
